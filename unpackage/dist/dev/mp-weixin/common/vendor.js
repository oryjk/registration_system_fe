...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__FAAE6B3",
    appName: "registration_system_fe",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
let targetHost = "";
const hosts = "192.168.1.10,192.168.58.1,192.168.168.1,172.19.32.1,172.29.112.1".split(",");
setTimeout(() => {
  index.request({
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "足球比赛报名"
    }
  },
  {
    path: "pages/history/history",
    style: {
      navigationBarTitleText: "比赛历史"
    }
  },
  {
  ...
  list: [
    {
      ...
      selectedIconPath: "static/image/tabbar/home_hl.png",
      text: "报名"
    },
    {
      pagePath: "pages/history/history",
      iconPath: "static/image/tabbar/soccer.png",
      selectedIconPath: "static/image/tabbar/soccer_hl.png",
      text: "历史"
    },
    {
      pagePath: "pages/mine/mine",
      iconPath: "static/image/tabbar/me.png",
      selectedIconPath: "static/image/tabbar/me_hl.png",
      text: "我的"
    }
  ]
};
